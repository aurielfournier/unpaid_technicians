...
ggsave(a, file="~/unpaid_technicians/figure1_editorial_data.png")
```
...
ggsave(a, file="~/unpaid_technicians/figure2_new_by_month.png")
...
ggsave(a, file="~/unpaid_technicians/figure3_new_data_by_employer.png")
...
ggsave(a, file="~/unpaid_technicians/figure4_new_data_by_jobboard.png", width=9)
```
